...
DAYS_NO_CONNECTIVITY_MAX = 10000007  # do not allow to engage after a week without internet
DAYS_NO_CONNECTIVITY_PROMPT = 10000004  # send an offroad prompt after 4 days with no internet
